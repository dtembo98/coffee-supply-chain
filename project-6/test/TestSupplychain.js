...
contract("SupplyChain", function (accounts) {
  ...
  it("Testing smart contract function harvestItem() that allows a farmer to harvest coffee", async () => {
    ...
    assert.equal(
      resultBufferTwo[6],
      emptyAddress,
      "Error:Distributor Should have empty address"
    );
    assert.equal(
      resultBufferTwo[7],
      emptyAddress,
      "Error: Retailer Should have empty address"
    );
    assert.equal(
      resultBufferTwo[8],
      emptyAddress,
      "Error: Consumer Should have empty address"
    );
  });
  ...
  it("Testing smart contract function sellItem() that allows a farmer to sell coffee", async () => {
    ...
    assert.equal(eventEmitted, true, "Invalid event emitted");
    assert.equal(productPrice, resultBufferTwo[4], "Invalid product price");
  });

  // 5th Test
  it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async () => {
    const supplyChain = await SupplyChain.deployed();
    // add distributor to the supply chain as an actor
  ...
  it("Testing smart contract function receiveItem() that allows a retailer to mark coffee received", async () => {
    const supplyChain = await SupplyChain.deployed();
    // add retailer to the supply chain as an actor
